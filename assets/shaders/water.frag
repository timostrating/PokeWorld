...
void main() {
    ...
    float distanceCompensation = clamp(1.0 - (v_pos.w * 0.015), 0.0, 1.0); // todo improve
...
//    outputColor = vec4(distanceCompensation, distanceCompensation, distanceCompensation, 1.0);
}